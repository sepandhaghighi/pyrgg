...
>>> import pydot
>>> random.seed(2)
>>> engine.generate_graph(dot_maker, 'testfile', {'vertices':10, 'edge_number':5, 'direct':0})
5
...
5
>>> random.seed(4)
>>> engine.generate_graph(dot_maker, 'testfile2', {'vertices':10, 'edge_number':8, 'direct':1})
8
