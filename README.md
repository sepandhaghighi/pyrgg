...
- `pip install pyrgg==1.7`						

### Source Code
- Download [Version 1.7](https://github.com/sepandhaghighi/pyrgg/archive/v1.7.zip) or [Latest Source ](https://github.com/sepandhaghighi/pyrgg/archive/dev.zip)
- `pip install .`
...
- Download [Exe-Version 1.7](https://github.com/sepandhaghighi/pyrgg/releases/download/v1.7/PYRGG-1.7.exe)
- Run `PYRGG-1.7.exe`
...
<table>
	...
	<tr>
		...
		<td align="center">Edge probabilities for between and within block connection. For undirected graph only the upper triangular indices would be counted.</td>
	</tr>
	<tr>
		<td align="center">Directed / Undirected</td>
		<td align="center">Specifies whether the graph is directed or undirected</td>
